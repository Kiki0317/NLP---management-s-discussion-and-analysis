...
import os
import time
path="C:/Users/广芮/Desktop/capstone/html_1"
...
for f in files:
    add= 'file:///C:/Users/广芮/Desktop/capstone/html_1/'+f
    page=urlopen(add)
    contents = page.read() 
...
search_ind.to_csv('SearchIndex_TXT.csv',index=False)
 ...
 ##################################################################################################################################################################       
path2="C:/Users/广芮/Desktop/capstone/TXT"
...
for u in files_2:
    add= 'file:///C:/Users/广芮/Desktop/capstone/TXT/'+u
    text=open(u, 'r').read()
    #clean txt
    clean_text=Cleaning_data(text)
    text_list = clean_text.split('.')
...
X=pd.DataFrame({'Xnegative':Xnegative,'Xpositive':Xpositive,'Xuncertainty':Xuncertainty,'Xconstraining':Xconstraining,'Xlitigious':Xlitigious,'Xmodal':Xmodal})
